...
#include "Turret/FreezingTurret.hpp"
...
const std::vector<int> PlayScene::code = {
    ...
    ALLEGRO_KEY_B, ALLEGRO_KEY_A, ALLEGRO_KEY_S, ALLEGRO_KEY_ENTER
};
    ...
    for (int i = 0; i < SpeedMult; i++) {
        ...
        if (enemyWaveData.empty()) {
            if (EnemyGroup->GetObjects().empty()) {
                ...
                if (winScene) {
                    winScene->SetResult(lives, money);
                }
                preview = nullptr;
    ...
    if (button & 1) {
        if (dynamic_cast<Shovel*>(preview)) {
            for (auto& obj : TowerGroup->GetObjects()) {
                ...
                if (turret && turret->Position.x == x * BlockSize + BlockSize / 2 &&
        ...
        if (mapState[y][x] != TILE_OCCUPIED) {
            ...
            if (auto landmine = dynamic_cast<Landmine*>(preview)) {
                landmine->placed = true;
            }
...
void PlayScene::OnKeyDown(int keyCode) {
    ...
    if (keyStrokes.size() == code.size() && std::vector<int>(keyStrokes.begin(), keyStrokes.end()) == code) {
...
void PlayScene::ConstructUI() {
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
                            ...
                            Engine::Sprite("play/turret-6.png", 1446, 136 - 8, 0, 0, 0, 0), 1446, 136, FreezingTurret::Price);
    btn->SetOnClickCallback(std::bind(&PlayScene::UIBtnClicked, this, 2));
    UIGroup->AddNewControlObject(btn);
    // Button 4
    btn = new TurretButton("play/floor.png", "play/dirt.png",
                            Engine::Sprite("play/shovel-base.png", 1294, 212, 0, 0, 0, 0),
                            Engine::Sprite("play/shovel.png", 1294, 212, 0, 0, 0, 0), 1294, 212, 0);
    btn->SetOnClickCallback(std::bind(&PlayScene::UIBtnClicked, this, 3));
    UIGroup->AddNewControlObject(btn);
    // Button 5
    btn = new TurretButton("play/floor.png", "play/dirt.png",
                            Engine::Sprite("play/shovel-base.png", 1370, 212, 0, 0, 0, 0),
                            Engine::Sprite("play/turret-fire.png", 1370, 212, 0, 0, 0, 0), 1370, 212, Landmine::Price);
...
void PlayScene::UIBtnClicked(int id) {
    ...
    else if (id == 2 && money >= FreezingTurret::Price)
        preview = new FreezingTurret(0, 0);
    else if (id == 3)
